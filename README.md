...
Sayt endi `source.unsplash.com` qidiruv havolalaridan foydalanmaydi. Har bir joy uchun `script.js` faylining boshida aniq va to'g'ridan-to'g'ri rasm havolalari berilgan:
...
Agar rasmlarni o'zingiz GitHub'ga yuklamoqchi bo'lsangiz, `images` papkasiga rasm fayllarini joylang va `script.js` ichida havolani mahalliy fayl yo'liga almashtiring.
